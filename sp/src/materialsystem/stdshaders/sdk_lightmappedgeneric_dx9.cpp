...
BEGIN_VS_SHADER( SDK_LightmappedGeneric,
	...
	BEGIN_SHADER_PARAMS
		...
		// SIRE: cool shit
		SHADER_PARAM( PHONG, SHADER_PARAM_TYPE_INTEGER, "0", "Whether phong shading is enabled.")
		SHADER_PARAM( PHONGEXPONENT, SHADER_PARAM_TYPE_FLOAT, "4.0", "Controls the size of the highlight i.e. \"roughness\" of the surface.")
		SHADER_PARAM( PHONGBOOST, SHADER_PARAM_TYPE_FLOAT, "1.0", "Multiplier for the phong brightness.")
...
END_SHADER_PARAMS
	...
	SHADER_INIT
	{
		...
		Msg("Custom LightmappedGeneric loaded.");
	}
